...
public class BlockNoReason  implements OperationTrigger {
    ...
    public SecuredMessageTriggerBean execute(SecuredMessageTriggerBean message) throws GranException {
        ...
        if (value==null || (value.equals(unsat) || value.equals(sat)) && message.getDescription().length()<10) throw new UserException("Вы должны указать причину выставления оценки исполнения", false);
        return message;
    }
}
